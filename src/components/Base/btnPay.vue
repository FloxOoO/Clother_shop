<template>
  <div
    v-if="productsStore.basket.length"
    class="container"
    @click="$emit('open-window-pay', true)"
  >
    <div class="btn-pay">
      <icon-mdi :icon="icons.mdiCashSync" class="btn-pay__icon" />
      <div 
        class="btn-pay__title"
      >
        Перейти к оплате
      </div>
    </div>
...
export default {
  ...
  emits: {
    'open-window-pay': (value) => value === true
  },
