  ...
  <div class="product-description">
    ...
    <div class="product-description__window">
      <div class="product-description__window-left">
        <p 
          v-for="(item, id) in productDescription"
          :key="id"
          class="item-list"
        >
    ...
    productDescription() {
      return [
        ...
        },
        {
          ...
          productDescription: this.product.sampler.match(/\d{1,}/g).splice(1).join('-')
        },
        {
        ...
        },
        {
          ...
          productDescription: this.product?.colors ? this.product.colors[0] : '-'
        },
        {
